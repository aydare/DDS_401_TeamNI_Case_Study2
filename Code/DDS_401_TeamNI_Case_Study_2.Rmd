...
table(pred_test_jobs,jobDF.test$Attrition)
```
...
```
According to our random forest analysis, the top 3 factors that contribute to attrition are Overtime, Monthly Income, and Environment Satisfaction. Let's take a deeper dive though, to really confirm.
